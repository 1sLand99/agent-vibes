...
```bash
# Download
curl -L -o agent-vibes-darwin-arm64-0.1.47.vsix https://github.com/funny-vibes/agent-vibes/releases/download/v0.1.47/agent-vibes-darwin-arm64-0.1.47.vsix

# Install
cursor --install-extension agent-vibes-darwin-arm64-0.1.47.vsix --force
```
...
```bash
# Download
curl -L -o agent-vibes-darwin-x64-0.1.47.vsix https://github.com/funny-vibes/agent-vibes/releases/download/v0.1.47/agent-vibes-darwin-x64-0.1.47.vsix

# Install
cursor --install-extension agent-vibes-darwin-x64-0.1.47.vsix --force
```
...
```bash
# Download
curl -L -o agent-vibes-linux-x64-0.1.47.vsix https://github.com/funny-vibes/agent-vibes/releases/download/v0.1.47/agent-vibes-linux-x64-0.1.47.vsix

# Install
cursor --install-extension agent-vibes-linux-x64-0.1.47.vsix --force
```
...
```powershell
# Download
Invoke-WebRequest -Uri "https://github.com/funny-vibes/agent-vibes/releases/download/v0.1.47/agent-vibes-win32-x64-0.1.47.vsix" -OutFile "agent-vibes-win32-x64-0.1.47.vsix"

# Install
cursor --install-extension agent-vibes-win32-x64-0.1.47.vsix --force
```
