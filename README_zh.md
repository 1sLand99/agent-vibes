...
# Install
cursor --install-extension agent-vibes-darwin-arm64-0.1.71.vsix --force
```
...
# Install
cursor --install-extension agent-vibes-darwin-x64-0.1.71.vsix --force
```
...
# Install
cursor --install-extension agent-vibes-linux-x64-0.1.71.vsix --force
```
...
# Install
cursor --install-extension agent-vibes-win32-x64-0.1.71.vsix --force
```
